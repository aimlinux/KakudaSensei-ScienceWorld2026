document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handlePrompt() {
        ...
        const hasAvoid = /よけ|避|避け|避けて|回避|回避して|クリア|ゴール|超え|越え|乗り越え|乗り越えて|全部|すべて|自動|解決|お願い|おねがい|進|すすむ|進んで|前進|前へ|前に|右へ|右に|左へ|左に|歩|歩いて|走|走って|ダッシュ|ジャンプ|ジャンプして|飛べ|飛んで|跳ねて|跳んで|飛び越え|飛び越えて/.test(normalizedText);
